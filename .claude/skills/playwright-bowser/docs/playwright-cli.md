...
In some cases you might want to install playwright-cli locally. If running the globally available `playwright-cli` binary fails, use `bunx playwright-cli` to run the commands. For example:

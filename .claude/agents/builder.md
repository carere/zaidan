...
- When finished, use `TaskUpdate` to mark your task as `completed` if a task ID is provided.
- If you encounter blockers, update the task (if a task ID is provided) or report with details but do NOT stop - attempt to resolve or work around.

                        ...
                        {(item) => (
                          <SidebarMenuItem class="relative">
                            ...
                            <SidebarMenuButton
                              ...
                              class="data-[status=active]:bg-accent data-[status=active]:border-accent relative h-[26px] w-fit cursor-pointer overflow-visible border border-transparent text-[0.8rem] font-normal after:absolute after:inset-x-0 after:-inset-y-1 after:z-0 after:rounded-md"
                            >
                              {item.title}

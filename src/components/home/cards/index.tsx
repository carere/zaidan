...
import { MessageScrollerPlaceholder } from "./message-scroller-placeholder";
...
export function CardsDemo() {
  return (
    <div
      data-slot="demo"
      class="theme-neutral relative flex w-full max-w-none flex-col gap-(--gap) overflow-hidden bg-muted p-12 pb-0! [--gap:--spacing(8)] lg:p-6 lg:[--gap:--spacing(6)] 3xl:[--gap:--spacing(8)] min-[1900px]:p-12 min-[1900px]:[--gap:--spacing(10)]! dark:bg-background"
    >
      <CardsSkeletonRails />
      <div class="relative z-10 mx-auto grid gap-(--gap) **:data-[slot=card]:w-full md:max-w-3xl md:grid-cols-2 lg:max-w-none lg:grid-cols-3 min-[1400px]:grid-cols-4! xl:max-w-[1600px] 2xl:max-w-[1900px] min-[1900px]:grid-cols-5!">

...
import { MailIcon, MapPinCheckInsideIcon, UserIcon } from "lucide-solid";
  ...
  const columns: ColumnDef<IData>[] = [
    {
      ...
      id: "name",
      header: ({ column }) => (
        <DataGridColumnHeader title="User" icon={<UserIcon />} column={column} />
      ),
      cell: ({ row }) => {
        return (
    ...
    },
    {
      accessorKey: "email",
      header: ({ column }) => (
        <DataGridColumnHeader title="Email" icon={<MailIcon />} column={column} />
      ),
      cell: (info) => (
    ...
    },
    {
      ...
      header: ({ column }) => (
        <DataGridColumnHeader title="Location" icon={<MapPinCheckInsideIcon />} column={column} />
      ),
      cell: ({ row }) => {
        return (

...
import { DataGridTableDnd } from "@/registry/kobalte/blocks/reui-data-grid/data-grid-table-dnd";
...
export default function Pattern() {
  ...
  const handleDragEnd = (event: { activeId: string; overId: string | null; canceled: boolean }) => {
    ...
    setColumnOrder((order) => {
      const oldIndex = order.indexOf(event.activeId);
      const newIndex = order.indexOf(event.overId as string);
  ...
  const columns: ColumnDef<IData>[] = [
    ...
    },
    {
      ...
      header: "Email",
      cell: (info) => (
        <a href={`mailto:${info.getValue()}`} class="hover:text-primary hover:underline">

  ...
  return (
    <ToastPrimitive.Root
      ...
      class={cn(
        ...
        "data-[limited]:opacity-0 data-[limited]:[--tw-exit-opacity:0]",
        "data-[opened]:animate-in data-[opened]:slide-in-from-bottom-[150%] data-[opened]:[--tw-animation-duration:500ms] data-[opened]:[--tw-ease:cubic-bezier(0.22,1,0.36,1)]",
        "data-[closed]:animate-out data-[closed]:slide-out-to-bottom-[150%] data-[closed]:[--tw-animation-duration:500ms] data-[closed]:[--tw-ease:cubic-bezier(0.22,1,0.36,1)]",
        "[&[data-closed]:not([data-swipe=end]):not([data-limited])]:[transform:translateY(150%)]",
        "data-[closed]:data-[swipe=end]:[--tw-animation-duration:200ms] data-[closed]:data-[swipe=end]:[--tw-ease:ease-out]",
        "data-[closed]:data-[swipe=end]:data-[swipe-direction=down]:[transform:translateY(calc(var(--kb-toast-swipe-end-y)+150%))] data-[closed]:data-[swipe=end]:data-[swipe-direction=down]:[--tw-exit-translate-y:calc(var(--kb-toast-swipe-end-y)+150%)]",
        "data-[closed]:data-[swipe=end]:data-[swipe-direction=left]:[transform:translateX(calc(var(--kb-toast-swipe-end-x)-150%))_translateY(var(--offset-y))] data-[closed]:data-[swipe=end]:data-[swipe-direction=left]:[--tw-exit-translate-x:calc(var(--kb-toast-swipe-end-x)-150%)] data-[closed]:data-[swipe=end]:data-[swipe-direction=left]:[--tw-exit-translate-y:var(--offset-y)]",
        "data-[closed]:data-[swipe=end]:data-[swipe-direction=right]:[transform:translateX(calc(var(--kb-toast-swipe-end-x)+150%))_translateY(var(--offset-y))] data-[closed]:data-[swipe=end]:data-[swipe-direction=right]:[--tw-exit-translate-x:calc(var(--kb-toast-swipe-end-x)+150%)] data-[closed]:data-[swipe=end]:data-[swipe-direction=right]:[--tw-exit-translate-y:var(--offset-y)]",
        "data-[closed]:data-[swipe=end]:data-[swipe-direction=up]:[transform:translateY(calc(var(--kb-toast-swipe-end-y)-150%))] data-[closed]:data-[swipe=end]:data-[swipe-direction=up]:[--tw-exit-translate-y:calc(var(--kb-toast-swipe-end-y)-150%)]",

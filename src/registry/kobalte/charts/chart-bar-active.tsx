...
import type { BarShapeProps } from "solid-recharts";
          ...
          <BarChart accessibilityLayer data={chartData}>
            ...
            <Bar
              ...
              shape={(props: BarShapeProps) => (
                <Rectangle
                  {...props}
                  fillOpacity={props.index === ACTIVE_INDEX ? 0.8 : props.fillOpacity}
                  stroke={
                    props.index === ACTIVE_INDEX
                      ? (props.payload as { fill?: string }).fill
                      : props.stroke
                  }
                  strokeDasharray={props.index === ACTIVE_INDEX ? 4 : undefined}
                  strokeDashoffset={props.index === ACTIVE_INDEX ? 4 : undefined}
                />
              )}
            />
          </BarChart>

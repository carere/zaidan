...
The panel gives you the install command, a preset class with your choices, and the wrapper to add around your content — plus a single prompt you can hand to a coding agent.

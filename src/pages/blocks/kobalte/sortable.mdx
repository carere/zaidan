...
The toast-emitting examples share a manager and mount its host around the gallery:

```tsx file=../../../registry/kobalte/examples/blocks/sortable-example.tsx#L14-L29
...
import { createToastManager, Toaster, type ToastManager } from "~/components/ui/toast";
...
```tsx file=../../../registry/kobalte/examples/blocks/sortable-example.tsx#L254-L298
...
```tsx file=../../../registry/kobalte/examples/blocks/sortable-example.tsx#L340-L384

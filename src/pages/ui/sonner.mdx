...
An opinionated toast component for SolidJS built on [Kobalte Toast](https://kobalte.dev/docs/core/components/toast).
...
Position the toasts at different locations:

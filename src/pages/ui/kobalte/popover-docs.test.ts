...
const pagePath = fileURLToPath(new URL("./popover.mdx", import.meta.url));
const demoNames = ["popover-demo", "popover-basic", "popover-alignments", "popover-form"];

describe("Popover documentation", () => {
  it("links every approved focused demo to a default-export Solid module", async () => {
    const page = await readFile(pagePath, "utf8");

    expect(page).toContain("Kobalte Popover");
    expect(page).toContain("https://kobalte.dev/docs/core/components/popover#api-reference");
    ...
    expect(page).not.toContain("popover-rtl");

...
foundation: kobalte
links:
  doc: https://kobalte.dev/docs/core/components/popper
  api: https://kobalte.dev/docs/core/components/popper#api-reference
---

The Select component uses a custom listbox and keyboard-navigation implementation, positioned with [Kobalte Popper](https://kobalte.dev/docs/core/components/popper).
...
See the [Kobalte Popper documentation](https://kobalte.dev/docs/core/components/popper) for the positioning primitive used by `SelectContent`.
...
See the [Kobalte Popper API reference](https://kobalte.dev/docs/core/components/popper#api-reference) for the positioning props used by `SelectContent`.

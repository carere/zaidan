...
### 2026-08-02 Corvu dynamic components

The wrapper now uses Corvu's [`DynamicProps`](https://corvu.dev/docs/dynamic-components/) directly. Resizable no longer requires Kobalte for polymorphic component types.

...
foundation: kobalte
links:
  doc: https://kobalte.dev/docs/core/components/label
  api: https://kobalte.dev/docs/core/components/label#api-reference
---
...
<ComponentPreview name="field-responsive" previewClass="h-[650px] p-6 md:h-[500px] md:p-10" />

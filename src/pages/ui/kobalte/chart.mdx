...
```tsx
import { chartTooltipDefaults } from "~/components/ui/chart"
...
```tsx
import { chartXAxisDefaults, chartYAxisDefaults } from "~/components/ui/chart"
...
```tsx
import { chartGridDefaults } from "~/components/ui/chart"
...
```tsx
import { chartLegendDefaults } from "~/components/ui/chart"

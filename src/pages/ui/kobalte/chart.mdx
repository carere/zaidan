...
title: Chart
slug: chart
description: Beautiful, composable charts built with Solid Recharts.
component: true
---
...
<ComponentPreview
  name="chart-demo"
  previewClass="h-auto p-0 [&>div]:w-full [&>div]:border-none [&>div]:shadow-none"
  hideCode
/>
...
<ComponentPreview name="chart-example" previewClass="h-80" />
...
<ComponentPreview name="chart-example-grid" previewClass="h-80" />
...
<ComponentPreview name="chart-example-axis" previewClass="h-80" />
...
<ComponentPreview name="chart-example-tooltip" previewClass="h-80" />
...
<ComponentPreview name="chart-example-legend" previewClass="h-80" />
...
`nameKey` maps a legend item to a different config key; colors are resolved from the chart config.
...
<ChartLegend content={(props) => <ChartLegendContent {...props} nameKey="browser" />} />;
```

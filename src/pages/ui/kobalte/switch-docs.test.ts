...
const pagePath = fileURLToPath(new URL("./switch.mdx", import.meta.url));
const demoNames = [
  "switch-demo",
  "switch-description",
  "switch-choice-card",
...
describe("Switch documentation", () => {
  it("links every approved focused demo to a default-export Solid module", async () => {
    ...
    for (const name of demoNames) {
      ...
      expect(demo).toContain('from "@/registry/kobalte/ui/switch"');
    ...
    expect(page).not.toContain("switch-rtl");

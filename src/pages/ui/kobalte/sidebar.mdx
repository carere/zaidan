...
Sidebar is a native SolidJS composition that provides desktop collapse, a mobile sheet, and a consistent set of navigation building blocks.

<ComponentPreview name="sidebar-demo" align="start" previewClass="h-[42rem] overflow-hidden p-0" />

...
For full-featured chat interfaces, use Bubble as the message surface and place avatars, names, timestamps, metadata, and message-level actions in the surrounding conversation UI.

...
const THEME_COLORS: RegistryItem[] = [
  {
    name: "neutral",
    title: "Neutral",
    type: "registry:theme",
...
export const THEMES_VARIANTS: RegistryItem[] = THEME_COLORS.map((theme) => ({
  ...theme,
  cssVars: {
    ...theme.cssVars,
    light: { ...SEMANTIC_COLORS.light, ...theme.cssVars?.light },
    dark: { ...SEMANTIC_COLORS.dark, ...theme.cssVars?.dark },
  },
}));

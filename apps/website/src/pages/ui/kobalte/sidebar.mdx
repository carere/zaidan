...
<ComponentPreview name="sidebar-demo" align="start" contained previewClass="h-[42rem] p-0" />
...
<ComponentPreview name="sidebar-floating" align="start" contained previewClass="h-[42rem] p-0" />

### Inset

Set `variant="inset"` and wrap the primary content in `SidebarInset`.

<ComponentPreview name="sidebar-inset" align="start" contained previewClass="h-[42rem] p-0" />

### Icon collapse

Set `collapsible="icon"` to collapse the sidebar to its icon rail instead of hiding it.

<ComponentPreview name="sidebar-icon" align="start" contained previewClass="h-[42rem] p-0" />

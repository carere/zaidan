...
const pagePath = fileURLToPath(new URL("./attachment.mdx", import.meta.url));
const demoNames = [
  "attachment-demo",
  "attachment-image",
  "attachment-states",
...
describe("Attachment documentation", () => {
  it("links every approved focused demo to a default-export Solid module", async () => {
    ...
    for (const name of demoNames) {
      ...
      expect(demo).toContain('from "@/registry/kobalte/ui/attachment"');
    ...
    expect(page).not.toContain("attachment-rtl");

...
const pagePath = fileURLToPath(new URL("./textarea.mdx", import.meta.url));
const demoNames = [
  "textarea-demo",
  "textarea-field",
  "textarea-disabled",
...
describe("Textarea documentation", () => {
  it("links every approved focused demo to a default-export Solid module", async () => {
    const page = await readFile(pagePath, "utf8");

    expect(page).toContain("HTML textarea element reference");
    ...
    expect(page).not.toContain("textarea-rtl");

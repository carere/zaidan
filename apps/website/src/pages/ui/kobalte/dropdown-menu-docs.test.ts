...
const pagePath = fileURLToPath(new URL("./dropdown-menu.mdx", import.meta.url));
const demoNames = [
  "dropdown-menu-demo",
  "dropdown-menu-basic",
...
describe("Dropdown Menu documentation", () => {
  it("links every approved focused demo to a default-export Solid module", async () => {
    const page = await readFile(pagePath, "utf8");

    expect(page).toContain("Kobalte Dropdown Menu");
    expect(page).toContain("https://kobalte.dev/docs/core/components/dropdown-menu#api-reference");
    ...
    expect(page).not.toContain("dropdown-menu-rtl");

...
const pagePath = fileURLToPath(new URL("./field.mdx", import.meta.url));
const demoNames = [
  "field-demo",
  "field-input",
  "field-textarea",
...
describe("Field documentation", () => {
  it("links every approved focused demo to a default-export Solid module", async () => {
    ...
    expect(page).toContain("Kobalte Label");
    expect(page).toContain("https://kobalte.dev/docs/core/components/label#api-reference");
    ...
    expect(page).not.toContain("field-rtl");

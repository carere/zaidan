...
<ComponentPreview name="attachment-demo" previewClass="h-auto bg-surface dark:bg-background" />

The `Attachment` component displays a file or image attachment, its media, name, and metadata,
...
```package-dlx
shadcn@latest add @zaidan/attachment
```
...
<Step>Install the required Zaidan dependency:</Step>
...
<ComponentPreview name="attachment-image" previewClass="h-auto bg-surface dark:bg-background" />
...
<ComponentPreview name="attachment-states" previewClass="h-auto bg-surface dark:bg-background" />

## Sizes

Use `size` to switch between `default`, `sm`, and `xs`.

<ComponentPreview name="attachment-sizes" previewClass="h-auto bg-surface dark:bg-background" />
...
<ComponentPreview name="attachment-group" previewClass="h-auto bg-surface dark:bg-background" />
...
<ComponentPreview name="attachment-trigger" previewClass="h-auto bg-surface dark:bg-background" />

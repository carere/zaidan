...
const pagePath = fileURLToPath(new URL("./carousel.mdx", import.meta.url));
const demoNames = [
  "carousel-demo",
  "carousel-size",
  "carousel-spacing",
...
describe("Carousel documentation", () => {
  it("links every approved focused demo to a default-export Solid module", async () => {
    ...
    expect(page).toContain("Embla Carousel");
    expect(page).toContain("https://www.embla-carousel.com/api/");
    ...
    for (const name of demoNames) {
      ...
      expect(demo).toContain('from "@/registry/kobalte/ui/carousel"');
    ...
    expect(page).not.toContain("carousel-rtl");

...
const pagePath = fileURLToPath(new URL("./dialog.mdx", import.meta.url));
const demoNames = [
  "dialog-demo",
  "dialog-close-button",
...
describe("Dialog documentation", () => {
  it("links every approved focused demo to a default-export Solid module", async () => {
    ...
    for (const name of demoNames) {
      ...
      expect(demo).toContain('from "@/registry/kobalte/ui/dialog"');
    ...
    expect(page).not.toContain("dialog-rtl");

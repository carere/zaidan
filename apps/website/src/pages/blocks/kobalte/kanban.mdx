...
<Step>Copy the following into `components/blocks/kanban/constants.ts`.</Step>

```ts file=../../../registry/kobalte/blocks/kanban/constants.ts showLineNumbers

```

<Step>Copy the following into `components/blocks/kanban/types.ts`.</Step>

```ts file=../../../registry/kobalte/blocks/kanban/types.ts showLineNumbers

```

<Step>Copy the following into `components/blocks/kanban/context.ts`.</Step>

```ts file=../../../registry/kobalte/blocks/kanban/context.ts showLineNumbers

```

<Step>Copy the following into `components/blocks/kanban/sorting.ts`.</Step>

```ts file=../../../registry/kobalte/blocks/kanban/sorting.ts showLineNumbers
...
<Step>Copy the following into `components/blocks/kanban/column.tsx`.</Step>

```tsx file=../../../registry/kobalte/blocks/kanban/column.tsx showLineNumbers

```

<Step>Copy the following into `components/blocks/kanban/item.tsx`.</Step>

```tsx file=../../../registry/kobalte/blocks/kanban/item.tsx showLineNumbers

```

<Step>Copy the following into `components/blocks/kanban/overlay.tsx`.</Step>

```tsx file=../../../registry/kobalte/blocks/kanban/overlay.tsx showLineNumbers

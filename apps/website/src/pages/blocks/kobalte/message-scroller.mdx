...
This is native Solid composition rather than a wrapped primitive. The full implementation lives in the [Message Scroller source](https://github.com/carere/zaidan/tree/main/apps/website/src/registry/kobalte/blocks/message-scroller).

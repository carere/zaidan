...
<Step>Copy the following into `components/blocks/sortable/context.ts`.</Step>

```ts file=../../../registry/kobalte/blocks/sortable/context.ts showLineNumbers

```

<Step>Copy the following into `components/blocks/sortable/sortable.tsx`.</Step>

```tsx file=../../../registry/kobalte/blocks/sortable/sortable.tsx showLineNumbers

```

<Step>Copy the following into `components/blocks/sortable/item.tsx`.</Step>

```tsx file=../../../registry/kobalte/blocks/sortable/item.tsx showLineNumbers

```

<Step>Copy the following into `components/blocks/sortable/overlay.tsx`.</Step>

```tsx file=../../../registry/kobalte/blocks/sortable/overlay.tsx showLineNumbers

```

<Step>Copy the barrel into `components/blocks/sortable/index.tsx`, so the folder can be imported as `~/components/blocks/sortable`.</Step>

```tsx file=../../../registry/kobalte/blocks/sortable/index.tsx showLineNumbers

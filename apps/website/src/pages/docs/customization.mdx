...
Every style includes the semantic color theme: `success`, `warning`, `info`, and their foregrounds, with light/dark values and Tailwind mappings. These tokens can be customized in your global CSS. To update an existing installation, re-add your style and accept the semantic color dependency.

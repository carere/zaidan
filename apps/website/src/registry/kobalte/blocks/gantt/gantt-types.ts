...
// biome-ignore lint/suspicious/noConfusingVoidType: `void` is the public contract - a handler that returns nothing accepts, and `undefined` would reject `() => void` callbacks.
